#3.3.	Apply the code on 20_newsgroup data set we worked in the previous classes
...
from sklearn.datasets import fetch_20newsgroups
#given code
newsgroups_train =fetch_20newsgroups(subset='train', shuffle=True, categories=catgs)
